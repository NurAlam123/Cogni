...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Ring 1 */}
      <div className="absolute w-[344px] h-[344px] md:h-[580px] md:w-[580px] border rounded-full top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 opacity-20">
      ...
      {/* Ring 2 */}
      <div className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] rounded-full border border-dashed border-white/20 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" />
      {/* Ring 3 */}
      <div className="absolute h-[544px] w-[544px] md:h-[980px] md:w-[980px] rounded-full border border-white opacity-20 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="absolute h-2 w-2 top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 bg-white rounded-full" />
