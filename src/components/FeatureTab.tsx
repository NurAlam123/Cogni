...
//Feature tab
const FeatureTab = (
  props: TabType[number] & ComponentPropsWithRef<"div"> & { selected: boolean },
) => {
  ...
  return (
    <div
      ...
      className="border border-white/15 flex lg:flex-1 p-2.5 rounded-xl gap-2.5 items-center relative"
